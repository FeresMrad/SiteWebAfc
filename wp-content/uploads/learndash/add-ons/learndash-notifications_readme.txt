...
* Added - New action hooks 'learndashnotificationsemailsent' and 'learndashnotificationsemailfailed'.
* Fixed - Triggering objects settings in notification model don't work correctly filtering events that triggers set up notifications.
* Fixed - User can't select specific quiz associated with a lesson because quiz was only direct child to topic. Now it can be direct child of course, lesson, or topic.
